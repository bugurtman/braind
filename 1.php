...
if (strlen($articleText)>200)//проверка на случай, если в статье меньше 200 символов
$articlePart=substr($articleText, 0, 199);//первые 200 символов для анонса
else $articlePart=$articleText;
